...
<img src="figs/download_zip_data_2022_09_18_v4.png" style="float: left; margin-right: 10px; padding-bottom: 20px; width: 80%; padding-left: 10%; padding-right:10%;" />
...
install.packages("https://anonymous.4open.science/r/HomeRange-D913/HomeRange_0.91.tar.gz", 
                 repos=NULL, 
                 method="libcurl")
